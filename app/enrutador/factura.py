from app.modelos.factura import Factura,FacturaCrear,FacturaEditar, FacturaLeer, FacturaLeerCompuesta
...
@rutas_factura.get("/factura", response_model=list[FacturaLeerCompuesta])
